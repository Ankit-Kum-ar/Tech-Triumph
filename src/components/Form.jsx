...
const Form = () => {
  return (
    <form className=" flex flex-col items-center text-sm text-slate-800 relative px-4 md:px-8 py-2 md:absolute md:right-20 bg-[#FFFFFF] rounded-2xl z-10 mt-2">
    ...
    <p className="max-md:text-sm text-gray-500 pb-10 text-center">
        Or just reach out manually to us at <a href="#" className="text-indigo-600 hover:underline">info@triumphtech.com</a>
    </p>
