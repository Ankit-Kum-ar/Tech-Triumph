...
const GettoKnowUs = () => {
  return (
    <div class="flex flex-col items-center bg-white py-16 px-4 max-w-5xl w-full text-center border border-primary rounded-2xl m-4">
...
bring your ideas to life.
    ...
    <div class="flex justify-center mt-6 max-sm:w-full">
        ...
        <Link to="/contactus" type="button" className="btn btn-primary hover:bg-indigo-600 px-4 py-2 text-white font-medium rounded-full">
            Contact Us
        </Link>
    </div>
</div>
